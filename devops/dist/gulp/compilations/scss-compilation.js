...
export var scssCompilation = function (distPath_1) {
    var args_1 = [];
    for (var _i = 1; _i < arguments.length; _i++) {
        args_1[_i - 1] = arguments[_i];
    }
    return __awaiter(void 0, __spreadArray([distPath_1], args_1, true), void 0, function (distPath, newName) {
        var e_1;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    e_1 = _a.sent();
                    console.error(getConsoleLogColors('error'), "SCSS compilation failed:", e_1 instanceof Error ? e_1.message : String(e_1));
